...
urlpatterns = [
   ...
   # path('logout/', auth_views.LogoutView.as_view(template_name='catalog/logout.html'), name='logout'),#
    ...
    path('password-reset/done/',
         auth_views.PasswordResetDoneView.as_view(template_name='catalog/password_reset_done.html'),
         name='password_reset_done'),
    path('password-reset-confirm/<uidb64>/<token>/',
         auth_views.PasswordResetConfirmView.as_view(template_name='catalog/password_reset_confirm.html'),
